...
This is the final form of the ``Non-Paraxial Ray-Tracing Equation''. We can solve this equation using the Frobenius method to approximate a solution using an infinite series:\\
